      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <motion.h1
            ...
            className="font-serif text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-medium text-white leading-[1.05] tracking-tight text-balance"
          >
            Virtual Operations
            <br />
            <span className="text-gold-400 italic">&amp; E-commerce</span>
            <br />
            Excellence
          </motion.h1>
          ...
          <motion.p
            ...
            className="font-sans text-lg md:text-xl text-white/60 leading-relaxed max-w-2xl"
          >
            I help ambitious e-commerce brands and global businesses streamline operations,
            grow revenue, and scale — without the overhead of a full-time hire.
          </motion.p>
